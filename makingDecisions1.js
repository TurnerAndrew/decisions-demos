...
// Jon Snow, adamant he does not want to fight Jamie (can you blame him?), picks up a shield to help defend himself. Increase Jon's jonSnowDefense by 25.

jonSnowDefense += 25

// Jamie attacks again - use an if/else to determine if Jon Snow can survive the attack. Make sure to account for Jon's jonSnowjonSnowDefense. If he does not, console.log "Jon Snow has been slain." Otherwise, condole.log Jon Snow's health.
